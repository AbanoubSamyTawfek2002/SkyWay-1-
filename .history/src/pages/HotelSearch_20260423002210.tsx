  ...
  const fetchHotels = async (isLoadMore = false) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        method: "GET",
        headers: {
          "x-rapidapi-key": import.meta.env.VITE_RAPIDAPI_KEY, // تأكد من وضع المفتاح في ملف .env
      ...
      // هنا يمكنك تحديث الـ pagination إذا كان الـ API يرجع بيانات الصفحات
      // setPagination({ page: 1, pages: 5 });
    } catch (err) {
