        ...
        if (result.paymentIntent.status === "succeeded") {
          ...
          await fetch(`${API_URL}/bookings`, {
            ...
            body: JSON.stringify({
              ...
              flightId:
                bookingData.type === "flight" ? bookingData.id : undefined,
              hotelId:
                bookingData.type === "hotel" ? bookingData.id : undefined,
              totalAmount: amount,
          ...
          <div className="aspect-[21/9] relative overflow-hidden">
            ...
            <div className="absolute bottom-10 left-10">
              <h2 className="text-4xl font-black text-white uppercase italic tracking-tighter">
                {type === "hotel" ? item.name : item.airline}
              </h2>
            ...
            <div className="grid grid-cols-2 gap-10">
              ...
              <div className="space-y-2">
                ...
                <p className="font-black italic uppercase italic">
                  {type === "hotel" ? "Luxe Property" : item.flightNumber}
                </p>
              </div>
            </div>
