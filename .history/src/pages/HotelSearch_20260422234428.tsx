    ...
    async (isLoadMore = false) => {
      ...
      try {
        const res = await fetch(
          "https://booking-com15.p.rapidapi.com/api/v1/hotels/searchHotels?dest_id=-2092174&search_type=CITY&adults=1&room_qty=1&page_number=1",
          {
            method: "GET",
            headers: {
        ...
        const hotelsWithImages = result.data.hotels.map((hotel: any) => ({
          ...hotel,
